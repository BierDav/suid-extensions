...
export interface CtSelectClasses {
...
export type SelectClassKey = keyof CtSelectClasses;

export function getSelectUtilityClasses(slot: string): string {
  return generateUtilityClass("CtSelect", slot);
}

const selectClasses: CtSelectClasses = generateUtilityClasses("CtSelect", [
  "select",
  "multiple",
  "filled",
  "outlined",
